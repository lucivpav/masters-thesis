...
\begin{table}
	...
	\begin{tabular}{|c|c|c|c|}
		...
		\hline
		sequentialPV, k=2 & 60.42\% & 79.14\% & 83.13\% \\
		\hline
		sequentialPV, k=3 & 60.74\% & 80.06\% & 83.13\% \\
		\hline
		sequentialPV, k=4 & 58.90\% & 79.14\% & 81.90\% \\
		\hline
		MultiCameraPose, k=2 & 65.03\% & \bfseries 80.37\% & \bfseries 83.74\% \\
		\hline
		MultiCameraPose, k=3 & \bfseries 65.34\% & 78.22\% & 82.82\% \\
		\hline
		MultiCameraPose, k=5 & 63.80\% & 77.30\% & 82.20\% \\
		\hline
	\end{tabular}
