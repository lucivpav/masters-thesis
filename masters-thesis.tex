...
\todo[we need an image with the following coordinate systems: World, Vicon, Marker (the stuff with beacons), Camera (maybe two cameras: one as the reference pose, one from HoloLens), Omega (initial unknown HL CS).]
