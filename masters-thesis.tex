...
\begin{itemize}
	...
	\item The ctuthesis style is kind of ugly. Increase the width of the text and remove blank page after chapter.
...
\begin{figure}[htb!]
	\centering
 	\includegraphics[width=0.86\textwidth]{evaluation-s10e/topView-B-315}
...
\begin{figure}[htb!]
	\centering
 	\includegraphics[width=0.76\textwidth]{evaluation-s10e/topView-B-670}
...
{
\newcommand{\thiswidth}{0.27\linewidth} 
\setlength{\tabcolsep}{1pt}
\cellspacetoplimit 2pt
\cellspacebottomlimit 2pt
\begin{figure*}[htb!]
...
\begin{figure}[htb!]
	\centering
 	\includegraphics[width=0.83\textwidth]{evaluation-HL1-v4.2-k2/topView-B-315}
