...
\begin{table}
	...
	\end{subtable}
	\caption{Quantitave evaluation of reference poses quality. HoloLens1 sequence shown. Tables show performance on the parameters, describing the Omega to camera transformation, \textbf{prior} using brute-force search optimization.}
