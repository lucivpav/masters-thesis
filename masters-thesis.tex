...
\TP{Rewrite the following paragraph to a homogeneous style, e.g., The objectives of this work is to (i) ...., (ii), ..., and (...)...}.
...
\begin{figure}[htb!]
	...
	\caption{The organization of the source code of the main pipeline implementation. Only notable items shown.}
\end{figure}
...
\begin{figure}[htb!]
	...
	\caption{The structure of the InLocCIIRC dataset. Only notable items shown. \todo[Habitat data should not be in InLocCIIRC\_dataset!]}
\end{figure}
...
\begin{table}[htb!]
	...
	\begin{tabular}{|c|c|c|}
		...
		\hline
		\code{inlierThreshold} & double & Unused; not implemented. \\
		\hline
		...
		\hline
	\end{tabular}
	\caption{The input parameters of the \code{multiCameraPose.m} MATLAB function. The function acts as an interface to the \code{MultiCameraPose} executable program.}
